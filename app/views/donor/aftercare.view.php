        ...
        <div class="d-dashboard-grid" style="grid-template-columns: 1fr; gap: 2rem;">
            ...
            <div class="d-widget">
                <div class="d-widget__header" style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <button class="d-btn d-btn--sm d-btn--primary" onclick="openAppointmentModal()"><i class="fas fa-plus"></i> Book Appointment</button>
                </div>
            ...
            <div class="d-widget">
                <div class="d-widget__header" style="display: flex; justify-content: space-between; align-items: center;">
                    <div class="d-widget__title"><i class="fas fa-envelope-open-text text-accent"></i> Support Requests</div>
