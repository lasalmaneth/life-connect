...
<head>
    ...
    <link rel="stylesheet" href="/life-connect/public/assets/css/common/header.css">
...
<body>
    ...
    <!-- Hero Section -->
    <section class="legal-overview-hero">
        <div class="hero-content">
            <div class="hero-text">
                <h1>Legal Overview</h1>
                <p class="hero-subtitle">Know your rights, responsibilities, and the law in Sri Lanka.</p>
                <a href="#sections" class="btn-hero"><i class="fas fa-book-open"></i> Read the Guidelines</a>
            </div>
            <div class="hero-visual">
                <img src="/life-connect/public/assets/images/faq-person1.jpg" class="hero-image" alt="Legal Overview" />
            </div>
        </div>
    </section>
    ...
    <main id="sections">
        <section class="legal-overview-section">
            <div class="container">
                <!-- Legal Overview Card -->
                <div class="legal-card">
                    <div class="card-header">
                        <i class="fas fa-scale-balanced"></i>
                        <h2>Legal Overview (Sri Lanka)</h2>
                    </div>
                ...
                <div class="legal-card">
                    <div class="card-header">
                        ...
                        <h2>Donor Rights & Responsibilities</h2>
                    </div>
                    <div class="card-content">
                        <ul class="bullet-list">
                ...
                <!-- Illegal Requests Card -->
                <div class="legal-card warning">
                    <div class="card-header">
                        <i class="fas fa-ban"></i>
                        <h2>Illegal Organ Requests & Public Awareness</h2>
                    </div>
                    <div class="card-content">
                        <div class="alert-box">
                            <i class="fas fa-triangle-exclamation"></i>
                            <span><strong>Public posts or social media requests for organs are illegal</strong> in Sri Lanka.</span>
                        </div>
                        <ul class="bullet-list">
                ...
                <div class="legal-card">
                    <div class="card-header">
                        ...
                        <h2>Post-Donation & Family Communication</h2>
                    </div>
                    <div class="card-content">
                        <ul class="bullet-list">
                ...
                <div class="legal-card">
                    <div class="card-header">
                        ...
                        <h2>Age & Eligibility Guidelines</h2>
                    </div>
                    <div class="card-content">
                        <ul class="bullet-list">
                ...
                <div class="legal-card">
                    <div class="card-header">
                        ...
                        <h2>Hospital & Legal Verification</h2>
                    </div>
                    <div class="card-content">
                        <p>Hospitals verify <strong>medical suitability, consent, and legal documents</strong> before proceeding.</p>
                        <div class="doc-list-box">
                            <h4>For deceased donors, required documents include:</h4>
                            <ul>
                                <li><i class="fas fa-check-circle"></i> Death certificate</li>
                                <li><i class="fas fa-check-circle"></i> GN (Grama Niladhari) certificate</li>
                                <li><i class="fas fa-check-circle"></i> Funeral parlor information</li>
                            </ul>
                        </div>
                        <p>Hospitals and LifeConnect ensure <strong>compliance with the law and safety protocols</strong>.</p>
                    </div>
                </div>
                ...
                <div class="legal-card">
                    ...
                    <div class="card-content">
                        <p>LifeConnect educates the public about:</p>
                        <ul class="bullet-list">
                        ...
                        <div class="resources-grid">
                            <div class="resource-item"><i class="fas fa-video"></i> Videos and explainers</div>
                            <div class="resource-item"><i class="fas fa-file-pdf"></i> PDF guides and forms</div>
                            <div class="resource-item"><i class="fas fa-heart"></i> Donor and recipient stories</div>
                            <div class="resource-item"><i class="fas fa-chart-line"></i> National transplant statistics</div>
                        </div>
                        <div class="info-box">
                            <i class="fas fa-circle-info"></i>
                            <span>This section addresses the <strong>unawareness of illegal organ requests</strong> and promotes <strong>safe, legal donation practices</strong>.</span>
                        </div>
                    </div>
                </div>
            </div>
