<div id="surgery-prep" class="content-section"
    ...
    <div class="content-header"
        style="background: white; border-bottom: 1px solid #e2e8f0; padding: 25px 30px; border-radius: 16px 16px 0 0;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div style="display: flex; align-items: center; gap: 15px;">
                <div
                    style="width: 45px; height: 45px; background: rgba(37, 99, 235, 0.1); border-radius: 12px; display: flex; align-items: center; justify-content: center; color: #2563eb;">
    ...
    <div class="content-body"
        style="padding: 30px; background: #f8fafc; border-radius: 0 0 16px 16px; border: 1px solid #e2e8f0; border-top: none;">
        <div
            ...
            <table style="width: 100%; border-collapse: collapse; text-align: left;">
                <thead>
                    <tr style="background: #f8fafc; border-bottom: 1px solid #e2e8f0;">
                        <th
                            style="padding: 18px 24px; font-size: 0.75rem; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em;">
                            Match ID</th>
                        <th
                            style="padding: 18px 24px; font-size: 0.75rem; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em;">
                            Donor Name</th>
                        ...
                        <th
                            ...
                            Status</th>
                        <th
                            style="padding: 18px 24px; font-size: 0.75rem; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em; text-align: right;">
                            Action</th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <?php foreach ($surgery_matches as $match): ?>
                            <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.2s;">
                                <td style="padding: 18px 24px;">
                                    <span
                                        style="font-weight: 700; color: #1e293b; font-size: 0.9rem;">#MAT-<?= str_pad($match->match_id, 4, '0', STR_PAD_LEFT) ?></span>
                                </td>
                                <td style="padding: 18px 24px;">
                                    <div style="font-weight: 700; color: #0f172a; font-size: 0.95rem;">
                                        <?= htmlspecialchars($match->donor_first_name . ' ' . $match->donor_last_name) ?>
                                    </div>
                                    <div style="font-size: 0.75rem; color: #64748b; margin-top: 2px;">Verified Donor</div>
                                </td>
                                <td style="padding: 18px 24px;">
                                    <span
                                        style="padding: 6px 12px; background: #eff6ff; color: #1e40af; border-radius: 8px; font-size: 0.8rem; font-weight: 700;">
                                ...
                                <td style="padding: 18px 24px;">
                                    ...
                                    <div style="font-size: 0.75rem; color: #94a3b8;">
                                        <?= date('h:i A', strtotime($match->surgery_date)) ?>
                                    </div>
                                </td>
                                <td style="padding: 18px 24px;">
                                    <?php
                                    ...
                                    ?>
                                    <span
                                        style="padding: 6px 14px; background: <?= $bg ?>; color: <?= $fg ?>; border-radius: 20px; font-size: 0.75rem; font-weight: 800; letter-spacing: 0.02em;">
                                        <?= $hStatus ?>
                                    </span>
                                </td>
                                <td style="padding: 18px 24px; text-align: right;">
                                    <button onclick="viewSurgeryMatchDetails(<?= $match->match_id ?>)"
                                        style="background: #2563eb; color: white; border: none; padding: 8px 16px; border-radius: 8px; font-weight: 700; font-size: 0.85rem; cursor: pointer; transition: all 0.2s; white-space: nowrap;">
                                        <i class="fas fa-info-circle" style="margin-right: 6px;"></i> Surgery
                                    </button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        ...
                        <tr>
                            <td colspan="6" style="padding: 60px 0; text-align: center;">
                                <div style="display: flex; flex-direction: column; align-items: center; gap: 15px;">
                                    <div
                                        style="width: 60px; height: 60px; background: #f8fafc; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #cbd5e1;">
                                        <i class="fas fa-calendar-times" style="font-size: 2rem;"></i>
                                    </div>
                                    <div style="color: #64748b; font-weight: 600;">No surgery matches found for clinical
                                        approval.</div>
                                </div>
                            </td>
                        </tr>
