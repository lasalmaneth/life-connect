                ...
                <div id="feedbacks" class="content-section" style="display: none;">
                    ...
                    <div class="content-body">
                        <div class="action-section">
                            ...
                            <div class="action-buttons">
                                <button class="btn btn-danger" id="bulk-delete-feedbacks"
                                    onclick="bulkDeleteFeedbacks()" disabled>Bulk Delete</button>
                            </div>
                        </div>
                        ...
                        <div class="data-table">
                            ...
                            <div class="table-content" id="feedbacks-table">
                                <div class="table-row" style="font-weight: 600; background: var(--gray-bg-color);">
                                    <div class="table-cell">
                                        <input type="checkbox" id="select-all-feedbacks"
                                            onchange="toggleSelectAllFeedbacks()"> User Details
                                    </div>
        ...
        <div class="modal-content" style="padding: 2.5rem; border-radius: 24px; max-width: 500px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 1.25rem; position: relative;">
                <button class="modal-close"
                    ...
                    onclick="closeModal('review-user-modal')">&times;</button>
    ...
    <div id="bulk-action-modal" class="modal">
        <div class="modal-content" style="padding: 2.5rem; border-radius: 24px; max-width: 500px;">
            <div style="display: flex; flex-direction: column; gap: 1.25rem; position: relative;">
                <button class="modal-close"
                    style="position: absolute; top: -15px; right: -15px; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%; background: #f1f5f9; border: none; cursor: pointer; color: #64748b; z-index: 10;"
                    onclick="closeModal('bulk-action-modal')">&times;</button>

                <div style="display: flex; align-items: center; gap: 1.25rem;">
                    <div id="bulk-status-icon-box"
                        style="flex-shrink: 0; width: 48px; height: 48px; background: #ecfdf5; border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                        <i id="bulk-status-icon" class="fa-solid fa-circle-check"
                            style="font-size: 20px; color: #059669;"></i>
                    </div>
                    <div>
                        <h2 id="bulk-modal-title"
                            style="margin: 0; font-size: 1.5rem; font-weight: 800; color: #0f172a; line-height: 1.2;">
                            Authorize Bulk Action</h2>
                    </div>
                </div>

                <div
                    style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 0.75rem 1rem; display: flex; align-items: center; gap: 10px;">
                    <span id="bulk-user-count-badge"
                        style="background: #3b82f6; color: white; padding: 2px 10px; border-radius: 20px; font-size: 0.75rem; font-weight: 800;">0
                        Users</span>
                    <span style="color: #64748b; font-size: 0.85rem; font-weight: 600;">Selected for status
                        update</span>
                </div>

                <p id="bulk-modal-desc"
                    style="margin: 0; color: #64748b; font-size: 0.9rem; line-height: 1.5; font-weight: 500;">Authorize
                    the following status transition and customize the review notification message below.</p>

                <!-- Editable Message Section -->
                <div>
                    <span
                        style="display: block; font-size: 0.7rem; font-weight: 800; color: #3b82f6; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 8px;">Review
                        Message (Editable)</span>
                    <textarea id="bulk-review-message" rows="4"
                        style="width: 100%; padding: 0.75rem; border-radius: 10px; border: 1.5px solid #e2e8f0; font-size: 0.9rem; color: #1e293b; outline: none; transition: border-color 0.2s; resize: none; font-weight: 500; line-height: 1.4;"></textarea>
                </div>

                <div style="display: flex; justify-content: flex-end; gap: 0.75rem; margin-top: 0.5rem;">
                    <button type="button" onclick="closeModal('bulk-action-modal')"
                        style="background: #f1f5f9; color: #475569; border: none; padding: 0.75rem 1.5rem; border-radius: 12px; font-weight: 700; cursor: pointer;">Cancel</button>
                    <button type="button" id="btn-confirm-bulk" onclick="executeBulkUpdate()"
                        style="background: #059669; color: white; border: none; padding: 0.75rem 1.5rem; border-radius: 12px; font-weight: 700; cursor: pointer; display: flex; align-items: center; gap: 8px; transition: all 0.2s;">
