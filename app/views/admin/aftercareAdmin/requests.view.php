        ...
        <div class="table-row support-row"
            ...
            <div class="table-cell" style="padding: 1.25rem 1.5rem; flex: 2;">
                ...
                <div style="font-size: 0.75rem; color: #94a3b8; font-weight: 500;">
                    <?= htmlspecialchars($request->patient_nic) ?></div>
            </div>
            ...
            <div class="table-cell" style="padding: 1.25rem 1.5rem; flex: 1.5;">
                ...
                ?>
                <span
                    style="display: inline-block; padding: 0.4rem 0.8rem; border-radius: 50px; font-size: 0.75rem; font-weight: 700; background: <?= $c['bg'] ?>; color: <?= $c['text'] ?>; white-space: nowrap;">
                    <?= $c['label'] ?>
                </span>
            </div>
        </div>
...
<?php else: ?>
    <div style="padding: 4rem 2rem; text-align: center; background: white; border-radius: 0 0 24px 24px;">
        <i class="fa-solid fa-folder-open"
            style="font-size: 3rem; color: #e2e8f0; margin-bottom: 1rem; display: block;"></i>
