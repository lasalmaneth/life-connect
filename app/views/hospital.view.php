...
<head>
    ...
    <link rel="stylesheet" href="/life-connect/public/assets/css/hospital/hospital.css">
    ...
    <div class="header">
        <div class="header-content">
            <div style="display: flex; align-items: center; gap: 1rem;">
                <a href="/life-connect" style="text-decoration:none; display:flex; align-items:center; gap:10px;">
                    <img src="/life-connect/public/assets/images/logo.png" alt="LifeConnect" style="height:40px; width: auto;">
                    <div>
                        ...
                        <div class="feature-grid">
                            <div class="feature-card" onclick="showContent('organ-requests')" style="cursor: pointer;">
                                <div class="feature-icon">
                                    <img src="/life-connect/public/assets/images/organ-requests.svg" alt="Organ Requests">
                                </div>
                            ...
                            <div class="feature-card" onclick="showContent('eligibility')" style="cursor: pointer;">
                                <div class="feature-icon">
                                    <img src="/life-connect/public/assets/images/search-donors.svg" alt="Search Donors">
                                </div>
                                <h3>Search Donors</h3>
                            ...
                            <div class="feature-card" onclick="showContent('eligibility')" style="cursor: pointer;">
                                <div class="feature-icon">
                                    <img src="/life-connect/public/assets/images/update-eligibility.svg" alt="Update Eligibility">
                                </div>
                            ...
                            <div class="feature-card" onclick="showContent('stories')" style="cursor: pointer;">
                                <div class="feature-icon">
                                    <img src="/life-connect/public/assets/images/tribute.jpg" alt="Success Stories" style="width: 60px; height: 60px; object-fit: cover; border-radius: 8px;">
                                </div>
                        ...
                        <div class="organ-request-options">
                            ...
                            <div class="organ-options-grid">
                                ...
                                <div class="organ-option-card" onclick="selectOrganType('liver')">
                                    <div class="option-image-container">
                                        <img src="/life-connect/public/assets/images/liver-transplant.jpg" 
